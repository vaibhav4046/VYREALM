...
export function validateGoogleOAuthUrl(value) {
  try {
    ...
    if (p.get('response_type') !== 'code' || p.get('code_challenge_method') !== 'S256' || p.get('access_type') !== 'offline' || !['consent','consent select_account'].includes(p.get('prompt'))) return null;
