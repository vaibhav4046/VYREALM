...
const names=new Set(['.gitignore','.env.example','README.md','package.json','package-lock.json','electron-builder.yml','playwright.config.mjs','index.html','styles.css','asset-library.css', 'creator-templates.css', 'local-automations.css', 'desktop/resources/icon.svg', 'desktop/resources/icon.ico', 'desktop/resources/icon.png','app.js','studio-chat.js','youtube-settings.js','server.js','engine.js','engine.test.mjs','cli.mjs','mcp-server.mjs','capabilities/manifest.json','runtime/manifest.json','workers/default-scene.json','docs/EMBERFORGE_TROUBLESHOOTING.md','docs/VYREALM_ARCHITECTURE.md','docs/MCP_ORIGINAL_SHOTS.md','docs/HACKATHON_VERIFICATION.md','docs/PUBLICATION_CHECKLIST.md']);
const extensions=new Set(['.js','.mjs','.cjs','.ts','.py','.ps1','.css','.html']);
for(const name of ['docs/YOUTUBE_SETUP.md','docs/ENGINE_RESEARCH_2026-09-08.md','runtime/notices/simple-icons-CC0.md','runtime/notices/simple-icons-provenance.json','runtime/notices/LTX-Video-license-provenance.json'])names.add(name);
